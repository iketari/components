...
/***/ function(module, exports, __webpack_require__) {
	...
	menu.el.addEventListener('pick', function (event) {
	  var faviconer = document.querySelector('.faviconer'),
...
/***/ function(module, exports) {
	...
	var Model = function () {
	  ...
	  _createClass(Model, [{
	    ...
	    key: "fetch",
	    value: function fetch(done, fail) {
	      var _this = this;

	      this._request('GET', null, function (xhr) {
	    ...
	    key: "save",
	    value: function save(done, fail) {
	      var _this2 = this;

	      var method = this._key ? 'PUT' : 'POST';

	      this._request(method, this.data, function (xhr) {
	        if (method === 'POST') {
	          _this2.setKey(JSON.parse(xhr.responseText).name);
	        } else if (method === 'PUT') {
	          _this2.setData(JSON.parse(xhr.responseText));
	        }

	        done && done(_this2, xhr, method);
	      }, fail);
	    }
	  }, {
	    key: "_getUrl",
	    value: function _getUrl() {
	      var url = HOST + "/" + this._resource;
	    ...
	    key: "_request",
	    value: function _request(method, data, callback, errback) {
	      var xhr = new XHR(),
	          model = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<a data-action=\"show\" href=\"#\" class=\"js-button pure-button\">" + (jade.escape(null == (jade_interp = 'Add new') ? "" : jade_interp)) + "</a><form class=\"js-form pure-form hidden\"><fieldset><input required=\"required\" type=\"url\" name=\"href\" placeholder=\"url\"><input required=\"required\" type=\"text\" name=\"anchor\" placeholder=\"text\"><button type=\"submit\" class=\"pure-button pure-button-primary\">" + (jade.escape(null == (jade_interp = 'Save') ? "" : jade_interp)) + "</button></fieldset></form>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div class=\"pure-menu custom-restricted-width\"><span class=\"pure-menu-heading\">" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</span><ul class=\"pure-menu-list\">");
	// iterate items
	;(function(){
	  var $$obj = items;
